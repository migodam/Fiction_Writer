...
const narrativeIDE = {
  ...
  runtimeRecoverable: (payload) => ipcRenderer.invoke('runtime:recoverable', payload),
  runtimeRun: (payload) => ipcRenderer.invoke('runtime:run', payload),
  runtimeEvents: (payload) => ipcRenderer.invoke('runtime:events', payload),
  runtimeEventStreamSubscribe: (payload) => ipcRenderer.invoke('runtime:event-stream-subscribe', payload),
  runtimeEventStreamUnsubscribe: (payload) => ipcRenderer.invoke('runtime:event-stream-unsubscribe', payload),
  onRuntimeEvent: (callback) => subscribe('runtime:event', callback),
  onRuntimeEventStreamStatus: (callback) => subscribe('runtime:event-stream-status', callback),
  runtimeCheckpoints: (payload) => ipcRenderer.invoke('runtime:checkpoints', payload),
  runtimePause: (payload) => ipcRenderer.invoke('runtime:pause', payload),
  runtimeResume: (payload) => ipcRenderer.invoke('runtime:resume', payload),
  runtimeCancel: (payload) => ipcRenderer.invoke('runtime:cancel', payload),
  runtimeFork: (payload) => ipcRenderer.invoke('runtime:fork', payload),
  runtimeDecision: (payload) => ipcRenderer.invoke('runtime:decision', payload),
